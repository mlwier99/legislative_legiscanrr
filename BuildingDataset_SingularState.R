...
full_tate_list<-c("AL","AK","AZ","AR","CA","CO","CT",
...
############### State Specific ############### 
  ...
  state <- ("MS")
  path_state <- paste0("data_json/", state, "/AllSessions") 
  ...
  #Saving files
  dir.create(path = paste0("data_r/", state))
  save(bill_indv_vote, file = paste0("data_r/", state, "/", state, "_bill_indv_votes.RData"))
  save(bill_people, file = paste0("data_r/", state, "/", state, "_bill_people.RData"))
  ...
  save(bill_master, file = paste0("data_r/", state, "/", state, "_bill_master.RData"))
}
